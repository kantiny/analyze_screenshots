...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.groupBox_test.setGeometry(QtCore.QRect(10, 220, 411, 61))
        ...
        self.pushButton_test.setGeometry(QtCore.QRect(80, 360, 271, 25))
        self.pushButton_test.setObjectName("pushButton_test")
        self.groupBox_test_file = QtWidgets.QGroupBox(Dialog)
        self.groupBox_test_file.setGeometry(QtCore.QRect(10, 290, 411, 61))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.pushButton_train.setText(_translate("Dialog", "Обучить модель"))
        self.groupBox_test.setTitle(_translate("Dialog", "Выберите дирректорию c тестовыми данными"))
        self.pushButton_test.setText(_translate("Dialog", "Тестировать полученную модель"))
        self.groupBox_test_file.setTitle(_translate("Dialog", "Введите имя файла, в который записать результат"))
